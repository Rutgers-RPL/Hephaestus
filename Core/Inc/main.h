...
#define IMU_SCK_Pin GPIO_PIN_0
#define IMU_SCK_GPIO_Port GPIOB
#define MAG_SCK_Pin GPIO_PIN_10
#define MAG_SCK_GPIO_Port GPIOB
#define IMU2_GYRO_CS_Pin GPIO_PIN_7
#define IMU2_GYRO_CS_GPIO_Port GPIOC
#define IMU2_GYRO_CSC8_Pin GPIO_PIN_8
#define IMU2_GYRO_CSC8_GPIO_Port GPIOC
#define IMU2_ACC_INT_Pin GPIO_PIN_9
#define IMU2_ACC_INT_GPIO_Port GPIOC
#define IMU2_ACC_CS_Pin GPIO_PIN_8
#define IMU2_ACC_CS_GPIO_Port GPIOA
#define IMU1_CS_Pin GPIO_PIN_9
#define IMU1_CS_GPIO_Port GPIOA
#define IMU_MOSI_Pin GPIO_PIN_10
...
#define BAR_INT_Pin GPIO_PIN_2
#define BAR_INT_GPIO_Port GPIOD
#define BAR_SCK_Pin GPIO_PIN_3
#define BAR_SCK_GPIO_Port GPIOB
#define BAR_MISO_Pin GPIO_PIN_4
#define BAR_MISO_GPIO_Port GPIOB
#define BAR_MOSI_Pin GPIO_PIN_5
#define BAR_MOSI_GPIO_Port GPIOB
#define BAR_CS_Pin GPIO_PIN_6
